...
Letterbook is a federated microblogging service. The goal of the project is to create and sustain a safe, robust, and self-determined social web. Those are big aspirations. We've made a strong start, and we would love more input about where to go from there.
