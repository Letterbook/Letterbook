...
For the last ten years or so, my work has focused on interface design for highly technical and often nuanced things, across a variety of domains. (and I often have to remind people what the "I" is in API). I've learned a lot of things through this work, but perhaps the most important is: when you are designing for practitioners, _you need to listen to the people doing the work_. So we conducted interviews with a small handful of people doing moderation work at a variety of scales and contexts: instances large & small, people moderating discord servers, people doing trust & safety work professionaly at scale. These interviews focused on trust & safety as it relates to administering and moderating servers; particularly the dedicated tools and features used by moderators. There is likely future work which could empower individual users with safety and curation tools, but this research was centered on the admin/moderation roles.

This article is a summary of what we've learned through our interviews, and focuses on the areas where the tooling for people doing moderation work could be improved, and what obstacles are involved to someone seeking to improve that tooling. I have some observations and recommendations that could be useful to fediverse software developers working on moderation tooling. We feel these learnings are worth sharing with others doing similar work in the fediverse. Cohesive designs for Letterbook's moderation features will come later. 
...
Context is also, often, information. _Who are the people involved?_ can become _What do we know about the people involved?_ Providing access to this kind of information is a common problem point for fediverse server software. One instance admin described giving their mod team read-only access to the database along with a library of queries to get at information their server software doesn't make available. There's lots of room to improve built-in tooling here!
...
One of the primary functions of moderator tooling is to answer questions that arise during moderation work: What is the history of a user who is the subject of a report -- what reports have been filed against them previously? What is the history of the user filing the report? Is this user receiving a lot of other reports at the same time? Who are the accounts doing the reporting?

If the report creator is remote, what information can you get about them? What is the recent or overall history of report exchanges between your instance and the remote instance? It can be hard to distinguish situations where someone is a bad actor compared to someone who is under attack by sockpuppet accounts, because Many fediverse backends anonymize Flag activities, so there's no way to know who made the report. There is [a proposal with the SWICG Trust & Safety task force](https://github.com/swicg/activitypub-trust-and-safety/issues/8) to attach opaque identifiers, which would at least allow reports from the same actor to be correlated with each other.
...
3. To help in keeping context about things that happened or things that are happening, implement note-taking and/or labels for everything, even some things you don't think need them. 
