...
public class FakeActor : Faker<DTO.Actor>
{
    ...
    public FakeActor()
    {
        ...
        RuleFor(o => o.Followers, (f, o) => new DTO.Collection{ Id = o.Id! + "/followers", Type = "Collection"});
        RuleFor(o => o.Following, (f, o) => new DTO.Collection{ Id = o.Id! + "/following", Type = "Collection"});
        RuleFor(o => o.Inbox, (f, o) => new DTO.Collection{ Id = o.Id! + "/inbox", Type = "Collection"});
        RuleFor(o => o.Outbox, (f, o) => new DTO.Collection{ Id = o.Id! + "/outbox", Type = "Collection"});
