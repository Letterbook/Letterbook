...
public interface IProfileService
{
    ...
    Task<FollowState> ReceiveFollowRequest(Uri targetId, Uri followerId, Uri? requestId);
    Task<FollowState> ReceiveFollowRequest(Guid localId, Uri followerId, Uri? requestId);
