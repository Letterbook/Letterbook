...
namespace Letterbook.Adapter.Db.Migrations
{
    ...
    [Migration("20251208054742_AddAudienceLabel")]
    partial class AddAudienceLabel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Letterbook.Core.Models.InviteCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Letterbook.Core.Models.ModerationReport", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("Forwarded")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Letterbook.Core.Models.Peer", b =>
                {
                    ...
                    b.Property<string>("PublicRemark")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Letterbook.Core.Models.ProfileClaims", b =>
                {
                    ...
                    b.PrimitiveCollection<List<ProfileClaim>>("Claims")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Letterbook.Core.Models.Account", b =>
                {
                    b.HasOne("Letterbook.Core.Models.InviteCode", "InvitedBy")
                        .WithMany("RedeemedBy")
            ...
            modelBuilder.Entity("Letterbook.Core.Models.InviteCode", b =>
                {
                    b.HasOne("Letterbook.Core.Models.Account", "CreatedBy")
                        .WithMany()
